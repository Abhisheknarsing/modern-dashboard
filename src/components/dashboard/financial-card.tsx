...
import { cn, formatCurrency, formatPercentage, getChangeType } from '@/lib/utils';
  ...
  return (
    ...
    >
      <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2 px-3 sm:px-6 pt-3 sm:pt-6">
        ...
        <Icon className="h-3 w-3 sm:h-4 sm:w-4 text-muted-foreground group-hover:text-primary group-hover:scale-110 transition-all duration-200 flex-shrink-0" />
      </CardHeader>
